    ...
    if path == "/api/feed":
            ...
            if cached is not None:
                ...
                for m in items_data:
                    latest.append({
                        ...
                        "latest_chapter_url": m.get("latest_chapter_url"),
                        "latest_chapter_time": m.get("updated_label"),
        ...
        for m in items:
            latest.append({
                ...
                "status": m.status,
                "rating": m.rating,
                "latest_chapter": m.latest_chapter,
                "latest_chapter_url": m.latest_chapter_url,
                "latest_chapter_time": m.updated_label,
